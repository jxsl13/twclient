...
T77|.|add README.md: library overview + dep-minimal note (V72) + install + quickstart (New→Connect→OnChat / observe) + 0.6/0.7 + link to godoc/pkg.go.dev + cmd-submodule note; ⊥ code change|V72,I.docs
