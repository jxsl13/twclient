...
T57|.|migrate all *_test.go to t.Context(): replace context.Background()/context.TODO() with t.Context() (base) or context.WithTimeout/WithCancel(t.Context(),…); ~31 sites across net6/net7/client/master tests; cancellation tests derive cancellable ctx from t.Context(); cmd/ harness exempt; full suite green incl -race|V66
```
