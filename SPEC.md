...
T75|.|remove dead code (V73): delete unused net6/net7 Session.recvUntilReadyToEnter, net6 securityTokenFromBE/securityTokenToBE, net6/net7 Session.DrainResponses (zero callers incl cmd module), client inputMinInterval const (+ stale doc ref); go vet + full suite incl -race green; ⊥ behavior change|V73,V48
